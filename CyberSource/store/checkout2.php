...
<?php include 'store_header.php';
	...
	$request['payPalEcSetService_run'] = "true";
	$request['payPalEcSetService_paypalReturn'] = "http://localhost/Gateways/index.php";
	$request['payPalEcSetService_paypalCancelReturn'] = "http://localhost/Gateways/index.php";
	...
	/*
	$request['merchantReferenceCode'] = time();
	...
	*/
	/*
	$request = array("payPalEcSetService_run"=>"true","merchantID"=>"HomeTownNewspaper","merchantReferenceCode"=>"HTNsubscription9647");
		$request = array_merge($request, array("purchaseTotals_currency"=>"USD","payPalEcSetService_paypalReturn"=>"http://www.cybersource.com"));
	//	$request = array_merge($request, array("payPalEcSetService_paypalCancelReturn"=>"http://www.cybersource.com/cancel"));
	//	$request = array_merge($request, array("payPalEcSetService_paypalBillingAgreementDesc"=>"Home Town Newspaper Online*4.99 per month"));
	//	$request = array_merge($request, array("payPalEcSetService_paypalBillingAgreementCustom"=>"One-year subscription"));
	//	$request = array_merge($request, array("payPalEcSetService_paypalBillingType"=>"MerchantInitiatedBilling"));
		$request = array_merge($request, array("payPalEcSetService_paypalPaymentType"=>"instant","purchaseTotals_grandTotalAmount"=>"4.99"));
	*/
	// send request now
	$reply = array();

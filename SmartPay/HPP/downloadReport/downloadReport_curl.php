...
$spReportUsername = "report@Company.<YourCompanyAccount>";
$spReportPassword = "<YourReportUserPassword>";
...
$reason="https://ca-test.barclaycardsmartpay.com/reports/download/MerchantAccount/<YourMerchantAccount>/payment_report_batch_1.csv";
...
function downloadReport($reportLocationRemote, $reportLoactionLocale) {
	global $spReportUsername, $spReportPassword;

	$login = 'Authorization: Basic ' .base64_encode($spReportUsername.':'.$spReportPassword) ;
	$header = array($login);

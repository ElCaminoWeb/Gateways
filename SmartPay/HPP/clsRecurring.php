...
public function startSOAP($operation="Payment") {
	...
	$this->client = new SoapClient( "https://pal-$host.barclaycardsmartpay.com/pal/{$operation}.wsdl",
			array(
				"location" => "https://pal-$host.barclaycardsmartpay.com/pal/servlet/soap/{$operation}",
				"login" => SOAP_USER,
				"password" => SOAP_PW,
				'trace' => 1,

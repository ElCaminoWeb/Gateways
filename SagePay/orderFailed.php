    ...
    <div id="pageContainer">
        ...
        <div id="content">
			...
			<p>Your transaction was not successful for the following reason:<br>
			  <br>
			  <span class="warning"><strong><?php echo $strReason ?></strong></span><br> 
			</p>
		<?php 
		if (strlen($strVendorTxCode)>0)
		{
		...
		?>
			    	<tr>
					    ...
					    <td class="fieldData"><?php echo $row["BillingFirstnames"] . " " . $row["BillingSurname"] ?>&nbsp;</td>
				    </tr>
				    <tr>
					    <td class="fieldLabel">Billing Phone:</td>
					    <td class="fieldData"><?php echo $row["BillingPhone"] ?>&nbsp;</td>
				    </tr>
				    <tr>
					    <td class="fieldLabel">Billing Address:</td>
					    <td class="fieldData">
				            <?php echo $row["BillingAddress1"] ?><BR>
				            <?php if (isset($row["BillingAddress2"]))  echo $row["BillingAddress2"] . "<BR>" ?>
				            <?php echo $row["BillingCity"] ?>&nbsp;
				            <?php if (isset($row["BillingState"]))  echo $row["BillingState"] ?><BR>
				            <?php echo $row["BillingPostCode"] ?><BR>
				            <script type="text/javascript" language="javascript">
				                document.write( getCountryName( "<?php  echo $row["BillingCountry"] ?>" ));
				            </script>
					    </td>
				    </tr>
				    <tr>
					    <td class="fieldLabel">Billing e-Mail:</td>
					    <td class="fieldData"><?php echo $row["CustomerEMail"] ?>&nbsp;</td>
				    </tr>
				    <tr>
					    <td class="fieldLabel">Delivery Name:</td>
					    <td class="fieldData"><?php echo $row["DeliveryFirstnames"] . " " . $row["DeliverySurname"] ?>&nbsp;</td>
				    </tr>
				    <tr>
					    <td class="fieldLabel">Delivery Address:</td>
					    <td class="fieldData">
				            <?php echo $row["DeliveryAddress1"] ?><BR>
				            <?php if (isset($row["DeliveryAddress2"])) echo $row["DeliveryAddress2"] . "<BR>" ?>
				            <?php echo $row["DeliveryCity"] ?>&nbsp;
				            <?php if (isset($row["DeliveryState"])) echo $row["DeliveryState"] ?><BR>
				            <?php echo $row["DeliveryPostCode"] ?><BR>
				            <script type="text/javascript" language="javascript">
				    ...
				    <tr>
					    ...
					    <td class="fieldData"><?php echo $row["DeliveryPhone"] ?>&nbsp;</td>
				    </tr>
		<?php
		echo "
					<tr>

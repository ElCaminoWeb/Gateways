...
$strDatabasePassword="test"; // Set the password for the above user here
$strDatabase="sagepay"; // Change this if you created a different database name
$strVirtualDir="Gateways/SagePay"; // Change if you've created a Virtual Directory in IIS with a different name
...
$strYourSiteFQDN="http://localhost/";

$strVendorName="sppaypaltest"; // Set this value to the Vendor Name assigned to you by Sage Pay or chosen when you applied
...
$link = mysql_connect('localhost',$strDatabaseUser,$strDatabasePassword); //Replace localhost if your database is hosted externally
mysql_select_db($strDatabase, $link) or die("Unable to select database");

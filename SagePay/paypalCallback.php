		...
		?>
			...
			<div class="<?php
				    if ($strStatus=="PAYPALOK")
						...
						echo "errorheader";
					?>" align="center">Sage Pay Direct returned a Status of <?php echo $strStatus ?><br>
				<span class="warning"><?php echo $strPageError ?></span>
			</div>
		<?php 
		...
		?>
			<table class="formTable">
				...
				<tr>
					...
					<td class="fieldData"><?php echo $strStatus ?>&nbsp;</td>
				</tr>
				<tr>
					<td class="fieldLabel">StatusDetail:</td>
					<td class="fieldData"><?php echo $strStatusDetail ?>&nbsp;</td>
				</tr>
				<tr>
					<td class="fieldLabel">VPSTxId:</td>
					<td class="fieldData"><?php echo $strVPSTxId ?>&nbsp;</td>
				</tr>
				<tr>
					<td class="fieldLabel">AddressStatus:</td>
					<td class="fieldData"><?php echo $strAddressStatus ?>&nbsp;</td>
				</tr>
				<tr>
					<td class="fieldLabel">PayerStatus:</td>
					<td class="fieldData"><?php echo $strPayerStatus ?>&nbsp;</td>
				</tr>
				<tr>
					<td class="fieldLabel">DeliverySurname:</td>
					<td class="fieldData"><?php echo $strDeliverySurname ?>&nbsp;</td>
				</tr>
				<tr>
					<td class="fieldLabel">DeliveryFirstnames:</td>
					<td class="fieldData"><?php echo $strDeliveryFirstnames ?>&nbsp;</td>
				</tr>
				<tr>
					<td class="fieldLabel">DeliveryAddress1:</td>
					<td class="fieldData"><?php echo $strDeliveryAddress1 ?>&nbsp;</td>
				</tr>
				<tr>
					<td class="fieldLabel">DeliveryAddress2:</td>
					<td class="fieldData"><?php echo $strDeliveryAddress2 ?>&nbsp;</td>
				</tr>
				<tr>
					<td class="fieldLabel">DeliveryCity:</td>
					<td class="fieldData"><?php echo $strDeliveryCity ?>&nbsp;</td>
				</tr>
				<tr>
					<td class="fieldLabel">DeliveryPostCode:</td>
					<td class="fieldData"><?php echo $strDeliveryPostCode ?>&nbsp;</td>
				</tr>
				<tr>
					<td class="fieldLabel">DeliveryCountry:</td>
					<td class="fieldData"><?php echo $strDeliveryCountry ?>&nbsp;</td>
				</tr>
				<tr>
					<td class="fieldLabel">DeliveryState:</td>
					<td class="fieldData"><?php echo $strDeliveryState ?>&nbsp;</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="fieldData"><?php echo $strPayerID ?>&nbsp;</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="fieldData"><?php echo $strVendorTxCode ?></td>
				</tr>
				<tr>
					<td class="fieldLabel">Order Total:</td>
					<td class="fieldData"><?php echo number_format($strAmount,2) . " " . $strCurrency ?>&nbsp;</td>
				</tr>
				<tr>
			...
			<div class="formFooter">
				...
				<input type="hidden" name="status" value="<?php echo $strStatus  ?>" />
